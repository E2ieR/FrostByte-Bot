...
const guildConfigSchema = new mongoose.Schema({
    ...
    sportsNotifications: {
        ...
        footballTeams:        { type: [{ id: Number, name: String, country: { type: String, default: '' } }], default: [] },
        footballPlayers:      { type: [{ id: Number, name: String, teamName: { type: String, default: '' } }], default: [] },
